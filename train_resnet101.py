...
from resnet101.network import build_ssd, resnet101_config
import numpy as np
import time
...
parser.add_argument('--multigpu', default=False, type=str2bool, help='Use multigpu to train the model')
...
def train():
    ...
    for iteration in range(args.start_iter, max_iter):
        ...
        if iteration % 5000 == 0:
            ...
            #             repr(iteration) + '.pth')
            torch.save(ssd_net.state_dict(), 'weights/ssd{}_resnet101_0712_{}.pth'.format(
                args.size, iteration
            ))
