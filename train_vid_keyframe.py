...
ssd_net = build_ssd_keyframe('train', ssd_dim, num_classes)
net = ssd_net
...
def train():
    ...
    dataset = VIDKeyframeDetection(train_sets, 'data/', VIDroot, transform=SSDAugmentationVideo(
    ...
    data_loader = data.DataLoader(dataset, batch_size, num_workers=args.num_workers,
                                  shuffle=True, collate_fn=detection_collate_context, pin_memory=True)
    tic = time.time()
